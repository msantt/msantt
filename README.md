...
scope:    "back-end · front-end · mobile · cybersecurity"
focus:    ["APIs", "Pentest Tooling", "Clean Architecture", "Flutter"]
...
# agora
building:
  - "ControleEntrega"  # FastAPI + MongoDB + JWT
  - "Tools Jacking"    # automação de pentest
  - "Mobile PenTest"   # Flutter + WebSockets
...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Sistema de logística interna com arquitetura limpa em camadas. Gerencia despacho de materiais com autenticação JWT, paginação e frontend dinâmico.</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>App Flutter que se comunica com backend FastAPI no Kali via WebSockets. Output de ferramentas em tempo real com autenticação JWT.</p>
      <p>
    ...
    <td width="50%" valign="top"> -->
      ...
      <a href="https://github.com/msantt/SUITS"><code>→ github.com/msantt/SUITS</code></a>
    </td>
  </tr>
</table>
